<?php
namespace Rinsvent\IdempotencyBundle\Tests\Helper;

// here you can define custom actions
// all public methods declared in helper class will be available in $I

use Predis\Client;
use Rinsvent\IdempotencyBundle\EventListener\IdempotencyListener;
use Rinsvent\IdempotencyBundle\Tests\unit\Listener\fixtures\Controller;
...
class Unit extends \Codeception\Module
{
    ...
    {
        return new Client('tcp://idempotencybundle_redis:6379?password=password123');
    }
